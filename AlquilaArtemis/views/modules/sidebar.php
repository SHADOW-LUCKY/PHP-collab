    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/tests/PHP-collab/AlquilaArtemis/views/pages/salidas" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/tests/PHP-collab/AlquilaArtemis/views/pages/productos" class="nav-link <?php if ($rutas[6] == "productos"): ?> active <?php endif ?>">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Productos
              </p>
